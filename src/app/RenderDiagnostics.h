...
// activity the app composed, and timed around the whole AppRenderer::draw,
...
void recordLoop();
void reportRenderDiagnostics(const AppRenderer&,TimeUs now);
...
void runRepaintCheck(AppRenderer&,M5GFX&,const SlotCatalog&);
#endif
}
#endif
