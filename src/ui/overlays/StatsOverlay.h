...
//
// The app hands it to the Renderer as the frame's overlay while the setting is
// on, and records the frame's time once the Renderer has returned.
class StatsOverlay final : public FrameOverlay {
public:
